      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-100 min-h-screen flex items-center justify-center">
        <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-6 sm:p-10">
          ...
          <form onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 text-white rounded-lg py-2 font-medium hover:bg-indigo-700 transition duration-200"
            >
              Sign In
            </button>
            ...
            <a
              href="#"
              className="block text-sm text-center text-indigo-500 mt-4 hover:underline"
            >
...
//               <button
//                 type="submit"
//                 className="w-full flex justify-center font-medium text-black bg-dark py-3 px-6 rounded-lg ease-out duration-200 hover:bg-blue mt-7.5"
//               >
//                 Sign in to account
//               </button>
