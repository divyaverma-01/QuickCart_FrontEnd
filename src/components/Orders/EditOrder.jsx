...
const EditOrder = ({ order, toggleModal }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Submit updated status to backend here if needed
    toggleModal(false);
  };
  ...
  return (
    <div className="w-full px-10">
      ...
      <div className="w-full">
        ...
        <button
          className="mt-5 w-full rounded-[10px] border border-blue-1 bg-blue-1 text-white py-3.5 px-5 text-custom-sm"
