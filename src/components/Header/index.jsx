  ...
  return (
    <header
      className={`border-b border-gray-200 w-full transition-all duration-300 ${
        stickyMenu
          ? "fixed top-0 left-0 z-50 bg-white shadow-md py-4"
          : "relative py-8 shadow-md"
      }`}
    >
      {/* Top Bar */}
      <div className="relative bg-white text-sm px-8 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2">
            <div className="flex border border-gray-300 rounded-md overflow-hidden shadow">
              ...
              <input
                ...
                className="px-4 py-2 w-72 outline-none text-base"
                value={searchQuery}
          ...
          {/* Right: Contact, Sign In, Cart, My Account */}
          <div className="flex items-center gap-8 text-gray-700 text-base font-medium">
            <div className="flex items-center gap-2">
              <FaPhoneAlt className="text-blue-600" />
              <div className="leading-tight">
                <p className="text-xs">24/7 SUPPORT</p>
                <p className="font-semibold">(+965) 7492-3477</p>
              </div>
            </div>
      ...
      {/* Navigation */}
      <nav className="w-full bg-white px-8 py-4 text-[18px] font-semibold text-gray-800">
...
//   return (
//     <header
//       className={`text-black fixed left-0 top-0 w-full z-9999 bg-white transition-all ease-in-out duration-300 ${
//         stickyMenu && "shadow"
//       }`}
//     >
